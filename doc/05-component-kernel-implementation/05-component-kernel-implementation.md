...
I use a Set<Integer> as the representation.

Each integer represents a race finishing position. The set allows efficient
addition and removal of arbitrary elements, which matches the behavior of removeAny.

@convention
- rep is not null
- all elements in rep are positive integers
- no duplicate values exist

@correspondence
- The abstract value is a collection of race results
- Each element in rep represents one stored race result
- The size of rep corresponds to historySize
